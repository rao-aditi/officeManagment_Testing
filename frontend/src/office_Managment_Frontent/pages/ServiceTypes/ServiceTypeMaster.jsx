...
const ServiceTypeMaster = () => {
  ...
  const canCreate = can(PERMISSION_KEYS.CREATE_SERVICE_TYPE);
  const canUpdate = can(PERMISSION_KEYS.UPDATE_SERVICE_TYPE);
  const canDelete = can(PERMISSION_KEYS.DELETE_SERVICE_TYPE);
